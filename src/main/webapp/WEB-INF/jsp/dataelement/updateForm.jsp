...
<body>
    ...
    <p></p>
     <p></p>
	<h1><fmt:message key="updateDataElement.heading"/></h1>
  
 <form:form modelAttribute="dataElement" action="${model.DataElement.id}" method="post" commandName="dataElement" >
  ...
  <table class="center">
    ...
    <tr>
        ...
        <td width="20%"><form:input path="description" size="30" maxlength="80"/></td>
    </tr>
    <tr>
      <td align="center" width="20%">Definition:<form:errors path="definition" cssClass="errors"/></td>
      <td width="20%"><form:input path="definition" size="30" maxlength="80"/></td>
    </tr>
     <tr>
