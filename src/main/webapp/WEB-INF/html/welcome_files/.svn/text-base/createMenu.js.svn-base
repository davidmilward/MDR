...
document.onclick = jsddm_close;
	...
	function createMenu(element){
		...
		newDiv = createLi("data element","dataelement/search"); 
		newDiv.appendTo(parentDiv);
		
		/*element 2 of submenu2*/
		newDiv = createLi("value domain","valuedomain/search");
		newDiv.appendTo(parentDiv);
		
		/*element 3 of submenu2*/
		newDiv = createLi("classification scheme","classificationscheme/search");
		newDiv.appendTo(parentDiv);
		...
		newDiv = createLi("data element","dataelement"); 
		newDiv.appendTo(parentDiv);
		
		/*element 2 of submenu5*/
		newDiv = createLi("value domain","createValueDomain");
		newDiv.appendTo(parentDiv);
		
		/*element 2 of submenu5*/
		newDiv = createLi("classification scheme","addClassificationScheme");
		newDiv.appendTo(parentDiv);
		...
		/*element 2 of submenu6*/
		newDiv = createLi("person","person");
		newDiv.appendTo(parentDiv);
		
		/*element 2 of submenu6*/
		newDiv = createLi("people","listpeople");
		newDiv.appendTo(parentDiv);
